                    ...
                    return (
                      <li key={index} className="grid-items">
                        <div className="tred-pro">
                          ...
                          <div className="pro-icn">
                            <a
                              ...
                              // onClick={() => numberValue.handleSubmitCart()}
                              className="w-c-q-icn"
                            >
                              <i
                                onClick={() => {
                                  numberValue.infor === ""
                                    ? alert("You must login to buy this item!!")
                                    : numberValue.handleSubmitCart();
                                  numberValue.getItem(index, products);
                                }}
                        ...
                        <div className="caption">
                          <h3>
                            <a href="javascript:void(0)">{elemet.product_name}</a>
                          </h3>
